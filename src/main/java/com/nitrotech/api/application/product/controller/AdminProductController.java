...
public class AdminProductController {
    ...
    public ResponseEntity<ApiResult<List<ProductData>>> list(
        ...
        ProductFilter filter = new ProductFilter(search, active, deleted, category, brand, minPrice, maxPrice, badge, false);
        return ResponseEntity.ok(ApiResult.paged(getProductsUseCase.execute(filter, pageable)));
    }
