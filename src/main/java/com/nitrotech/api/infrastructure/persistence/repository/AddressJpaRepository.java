...
public interface AddressJpaRepository extends JpaRepository<AddressEntity, Long> {
    ...
    @Query(value = "UPDATE addresses SET default_address = (id = :addressId), updated_at = CURRENT_TIMESTAMP WHERE user_id = :userId", nativeQuery = true)
    void unsetAllDefaultAddresses(@Param("userId") Long userId, @Param("addressId") Long addressId);
