...
public interface PaymentTransactionJpaRepository extends JpaRepository<PaymentTransactionEntity, Long> {
    ...
    Optional<PaymentTransactionEntity> findTopByOrderIdOrderByCreatedAtDesc(Long orderId);
    List<PaymentTransactionEntity> findByOrderIdInOrderByCreatedAtDesc(List<Long> orderIds);
}
